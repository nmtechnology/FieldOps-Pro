        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    <a href="/admin/reports/sales" class="bg-gray-800 hover:bg-gray-700 transition overflow-hidden shadow-sm sm:rounded-lg p-6 block">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <div class="text-sm font-medium text-gray-300">Sales Report</div>
                                <div class="text-xs text-gray-400">View detailed sales data</div>
                            </div>
                        </div>
                    </a>
                    <a href="/admin/reports/sales-tax" class="bg-gray-800 hover:bg-gray-700 transition overflow-hidden shadow-sm sm:rounded-lg p-6 block border-2 border-green-600">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <div class="text-sm font-medium text-white">Sales Tax Report</div>
                                <div class="text-xs text-green-400">Tax collected by state</div>
                            </div>
                        </div>
                    </a>
                    <a href="/admin/reports/customers" class="bg-gray-800 hover:bg-gray-700 transition overflow-hidden shadow-sm sm:rounded-lg p-6 block">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <div class="text-sm font-medium text-gray-300">Customer Report</div>
                                <div class="text-xs text-gray-400">View customer analytics</div>
                            </div>
                        </div>
                    </a>
                </div>

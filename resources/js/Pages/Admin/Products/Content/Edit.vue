    ...
    <AdminLayout>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                <!-- Unpublished Warning -->
                <div v-if="!form.is_published" class="bg-yellow-900/50 border-l-4 border-yellow-500 p-4 rounded-lg">
                    <div class="flex items-center">
                        <svg class="w-6 h-6 text-yellow-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path>
                        </svg>
                        <div>
                            <p class="text-yellow-200 font-semibold">This section is not published</p>
                            <p class="text-yellow-300 text-sm mt-1">Content blocks will not be visible to customers until you check the "Published" checkbox below and save.</p>
                        </div>
                    </div>
                </div>

...
const form = useForm({
    ...
    title: '',
    description: '',
    section_type: props.parent ? 'section' : 'chapter',
        ...
        <template #header>
            <div class="flex justify-between items-center">
                <h2 class="font-semibold text-xl text-white leading-tight">
                    Add {{ parent ? 'Section' : 'Chapter' }}: {{ product.name }}
                ...
                <div class="bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-200">
                        <form @submit.prevent="submit" class="space-y-6">
                            <div>
                                <InputLabel for="title" :value="parent ? 'Section Title' : 'Chapter Title'" />
                                <TextInput
                                    id="title"
                                    type="text"
                                    ...
                                    required
                                    autofocus
                                    placeholder="e.g., Getting Started with Field Operations"
                                />
                            ...
                            <div class="bg-blue-900 border border-blue-700 rounded-md p-4">
                                <p class="text-sm text-blue-200">
                                    <strong>Note:</strong> After creating this {{ parent ? 'section' : 'chapter' }}, you'll be able to add content blocks (text, images, videos) to build out the material.
                                </p>
                            </div>

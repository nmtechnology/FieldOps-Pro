<template>
    <Head>
        <title>Terms and Conditions - FieldEngineer Pro</title>
        <meta name="description" content="Terms and conditions for using FieldEngineer Pro services">
    </Head>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="p-6 sm:p-8">
                        ...
                        <div class="prose prose-indigo dark:prose-invert max-w-none dark:text-gray-300">
                            ...
                            <p>By subscribing to FieldOps Pro ($33.99/month) or FieldOps Elite ($44.99/month), you authorize us to charge your payment method on a monthly recurring basis. Your subscription will continue automatically until you cancel.</p>
                            
                            <h2>12. Accessing Your Content</h2>
                            <p>Upon successful payment, you will have immediate access to the tier-specific content. For subscription tiers, access continues as long as your subscription remains active. For one-time purchases (FieldOps Scout), you will have perpetual access to the purchased content.</p>
                            
                            <h2>13. Modifications to Terms</h2>
                            <p>We reserve the right to modify these terms at any time. We will notify you of significant changes to the terms via email or through a notification on our website.</p>
                            
                            <h2>14. Customer Support</h2>
                            <p>For questions about these terms or issues with your subscription, please contact our customer support team through the contact form on our website.</p>
                            
                            <h2>15. Agreement to Terms</h2>
                            <p>By using our platform, purchasing our products, or subscribing to our services, you acknowledge that you have read, understood, and agree to be bound by these terms and conditions.</p>
                            
                            <p class="mt-8 text-sm text-gray-500 dark:text-gray-400">Last updated: October 16, 2025</p>
                        </div>
                    </div>
                </div>
            </div>

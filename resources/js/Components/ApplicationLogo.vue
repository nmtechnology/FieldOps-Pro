<template>
    <svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" class="fieldops-logo">
        <defs>
            <!-- Skin tone gradient -->
        ...
        <rect x="28" y="46" width="8" height="4" fill="#1e40af" opacity="0.5"/>
        ...
        <!-- Screwdriver Tool (Orange handle) -->
        ...
        <!-- Boot Details (lighter brown) -->
        <rect x="22" y="56" width="8" height="2" fill="#92400e"/>
        <rect x="34" y="56" width="8" height="2" fill="#92400e"/>
        
        <!-- Pixel art style outline/shadow effects -->
        <rect x="20" y="32" width="2" height="2" fill="#000000" opacity="0.2"/>
        <rect x="42" y="32" width="2" height="2" fill="#000000" opacity="0.2"/>
    </svg>
</template>
